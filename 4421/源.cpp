...
//http://blog.csdn.net/luo_xianming/article/details/23091641
...
int main()
{
	...
	CreateFile("DirC", "File2");
	CreateFile("root", "File3");
	
	//if (MoveDir("DirB", "DirD"))
	//	cout << "false" << endl;
	//else
	//	cout << dir.find("DirB")->second.father->name << endl;
	//DeleteDir("DirA");
	//DeleteDir("DirB");
	////DeleteDir("DirC");
	cout << GetFileNum("root") << endl;
	//DeleteFile("File3");
	DeleteDir("DirA");
	cout << GetFileNum("root") << endl;
